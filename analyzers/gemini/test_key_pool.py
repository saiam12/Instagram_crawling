...
class PoolTests(unittest.TestCase):
    ...
    def test_minute_quota_recovers(self):
        ...
        with patch('key_pool.time.time', return_value=1000):
        ...
        with patch('key_pool.time.time', return_value=1013):
    ...
    def test_daily_quota_persists_and_resets(self):
        ...
        with patch('key_pool._today_str', return_value='2099-01-01'):
    ...
    def test_all_daily_exhausted_does_not_sleep(self):
        ...
        with patch('key_pool.time.sleep') as sleep:
